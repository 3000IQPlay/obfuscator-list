...
| Name | Description |
|------|------------|
| [Allatori](http://www.allatori.com/) | Was a somewhat popular choice in industry. The v3 has been leaked a long time ago [Allatori-V3](https://github.com/netindev/Allatori-v3.0), tho not nothing special. Can be mainly found used on Java based Malware. |
